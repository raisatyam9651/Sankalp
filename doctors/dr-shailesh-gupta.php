<?php
$doc_name = "Dr. Shailesh Gupta";
$doc_title = "Best Cardiologist in Ambikapur | Heart Specialist - Dr. Shailesh Gupta";
$doc_desc = "Consult Dr. Shailesh Gupta, the best cardiologist and physician in Ambikapur. Expert heart care, hypertension management, and diabetes treatment at Sankalp Hospital.";
$doc_specialty = "Cardiology & Internal Medicine";
$doc_degree = "MBBS, MD (Medicine)";
$doc_experience = "15+ Years";
$doc_designation = "Senior Physician & Heart Specialist";
$doc_image = "/assets/img/doctors/shailesh-gupta.jpg";
$doc_bio = "Dr. Shailesh Gupta is a highly experienced Physician and Cardiologist at Sankalp Hospital. With over 15 years of clinical practice, he specializes in managing complex medical conditions, particularly heart disease, hypertension, and metabolic disorders like diabetes.";
$doc_keywords = ["Heart Disease", "Hypertension", "Diabetes Management", "General Medicine", "Preventive Cardiology"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row g-5">
      <div class="col-lg-7">
        <div class="doc-content">
          ...
          <p>As the <strong>best cardiologist in Ambikapur</strong>, Dr. Shailesh Gupta focuses on early detection and prevention of cardiovascular diseases:</p>
          <div class="mb-4">
          ...
          <h2 class="mt-5">Heart & Lifestyle Care</h2>
          <p>Dr. Shailesh provides comprehensive care for heart patients, including management of stable angina, heart failure, and complex arrhythmias. He also manages chronic lifestyle diseases like hypertension and diabetes, ensuring his patients live long and healthy lives.</p>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="sticky-top" style="top:100px">
          <div class="card border-0 shadow-lg rounded-4 p-4">
            ...
            <form accept-charset='UTF-8' action='https://app.formester.com/forms/UvGLKUCJe/submissions' method='POST'>
              ...
              <div class="mb-3">
                <label class="form-label small fw-bold">Health Concern</label>
                <textarea name="message" class="form-control" rows="3">I need a consultation for heart/medical issues.</textarea>
              </div>
