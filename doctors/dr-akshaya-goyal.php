<?php
$doc_name = "Dr. Akshaya Goyal";
$doc_title = "Best Eye Specialist in Ambikapur | Ophthalmologist - Dr. Akshaya Goyal";
$doc_desc = "Consult Dr. Akshaya Goyal, the best eye specialist in Ambikapur. Expert treatment for cataracts, glaucoma, and refractive errors at Sankalp Hospital.";
$doc_specialty = "Ophthalmology (Eye Care)";
$doc_degree = "MBBS, MS (Ophthalmology)";
$doc_experience = "7+ Years";
$doc_designation = "Consultant Ophthalmologist";
$doc_image = "/assets/img/doctors/akshaya-goyal.jpg";
$doc_bio = "Dr. Akshaya Goyal is a skilled Eye Specialist at Sankalp Hospital, dedicated to providing advanced eye care services. He specializes in modern cataract surgery and managing complex eye conditions, ensuring clear vision for his patients in Ambikapur.";
$doc_keywords = ["Phaco Cataract Surgery", "Glaucoma Management", "Diabetic Retinopathy", "Refractive Errors", "Eye Trauma"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row g-5">
      <div class="col-lg-7">
        <div class="doc-content">
          <h2>Eye Care Expertise</h2>
          <p>As a leading <strong>eye specialist in Ambikapur</strong>, Dr. Akshaya Goyal provides state-of-the-art diagnostic and surgical solutions for various eye problems:</p>
          <div class="mb-4">
          ...
          <h2 class="mt-5">Restoring Your Vision</h2>
          <p>Dr. Akshaya is committed to preventing blindness and restoring vision. He utilizes the latest Phacoemulsification technology for cataract surgery, allowing for stitch-less and painless recovery. He also specializes in managing glaucoma and diabetic retinopathy to protect your long-term eye health.</p>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="sticky-top" style="top:100px">
          <div class="card border-0 shadow-lg rounded-4 p-4">
            ...
            <form accept-charset='UTF-8' action='https://app.formester.com/forms/UvGLKUCJe/submissions' method='POST'>
              ...
              <div class="mb-3">
                <label class="form-label small fw-bold">Eye Concern</label>
                <textarea name="message" class="form-control" rows="3">I need an eye checkup consultation.</textarea>
              </div>
