<?php
$doc_name = "Dr. Megha Goyal";
$doc_title = "Best Neonatologist in Ambikapur | Child Specialist - Dr. Megha Goyal";
$doc_desc = "Consult Dr. Megha Goyal, the best neonatologist and child specialist in Ambikapur. Expert care for premature babies, newborn health, and pediatric issues at Sankalp Hospital.";
$doc_specialty = "Neonatology & Pediatrics";
$doc_degree = "MBBS, MD (Pediatrics)";
$doc_experience = "7+ Years";
$doc_designation = "Consultant Neonatologist";
$doc_image = "/assets/img/doctors/megha-goyal.jpg";
$doc_bio = "Dr. Megha Goyal is a dedicated Neonatologist at Sankalp Hospital, specializing in the care of newborns and premature infants. Her expertise in the Neonatal Intensive Care Unit (NICU) has saved many lives, providing the highest standard of care for the most vulnerable patients.";
$doc_keywords = ["Newborn Care", "NICU Specialist", "Premature Baby Care", "Pediatric Emergencies", "Childhood Immunization"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row g-5">
      <div class="col-lg-7">
        <div class="doc-content">
          <h2>Neonatal & Pediatric Care</h2>
          <p>As the <strong>best neonatologist in Ambikapur</strong>, Dr. Megha Goyal provides specialized medical attention for newborns requiring intensive care:</p>
          <div class="mb-4">
          ...
          <h2 class="mt-5">Expert Care for Every Child</h2>
          <p>Dr. Megha's dedication to neonatal health ensures that every baby born at Sankalp Hospital has immediate access to expert care if complications arise. She also provides regular pediatric consultations, guiding parents through the crucial early years of their child's development.</p>
        </div>
      </div>
      <div class="col-lg-5">
          ...
          <div class="card border-0 shadow-lg rounded-4 p-4">
            ...
            <form accept-charset='UTF-8' action='https://app.formester.com/forms/UvGLKUCJe/submissions' method='POST'>
              ...
              <div class="mb-3">
                ...
                <textarea name="message" class="form-control" rows="3">I need a pediatric/neonatal consultation.</textarea>
              </div>
