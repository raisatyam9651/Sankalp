<?php
$doc_name = "Dr. Sanjay Goyal";
$doc_title = "Best Eye Surgeon in Ambikapur | Senior Ophthalmologist - Dr. Sanjay Goyal";
$doc_desc = "Consult Dr. Sanjay Goyal, the most experienced eye surgeon in Ambikapur. Founder of Sankalp Hospital and expert in advanced cataract and laser eye surgery.";
$doc_specialty = "Ophthalmology (Senior Specialist)";
$doc_degree = "MBBS, MS (Ophthalmology)";
$doc_experience = "25+ Years";
$doc_designation = "Founder & Senior Eye Surgeon";
$doc_image = "/assets/img/doctors/sanjay-goyal.jpg";
$doc_bio = "Dr. Sanjay Goyal is the founder of Sankalp Hospital and a pioneer of modern ophthalmology in the Surguja region. With over 25 years of experience, he has performed thousands of successful eye surgeries and is dedicated to providing world-class vision care to the community.";
$doc_keywords = ["Micro-Incision Cataract Surgery", "Laser Eye Treatment", "Ocular Trauma", "Corneal Diseases", "Comprehensive Eye Care"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row g-5">
      <div class="col-lg-7">
        <div class="doc-content">
          <h2>Vision & Eye Care</h2>
          <p>As the <strong>most experienced eye surgeon in Ambikapur</strong>, Dr. Sanjay Goyal has dedicated his life to improving eye health and preventing blindness in Northern Chhattisgarh:</p>
          <div class="mb-4">
          ...
          <h2 class="mt-5">Legacy of Care</h2>
          <p>Dr. Sanjay's vision for Sankalp Hospital was to provide world-class healthcare facilities to the people of Ambikapur at affordable costs. His expertise in complex ocular trauma and advanced cataract surgery makes him the most sought-after ophthalmologist in the region.</p>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="sticky-top" style="top:100px">
          <div class="card border-0 shadow-lg rounded-4 p-4">
            ...
            <form accept-charset='UTF-8' action='https://app.formester.com/forms/UvGLKUCJe/submissions' method='POST'>
              ...
              <div class="mb-3">
                <label class="form-label small fw-bold">Eye Condition</label>
                <textarea name="message" class="form-control" rows="3">I would like to consult Dr. Sanjay Goyal for my eye condition.</textarea>
              </div>
              <button type="submit" class="btn btn-primary w-100 py-3 shadow">Send Request</button>
            </form>
          </div>
        </div>
      </div>
