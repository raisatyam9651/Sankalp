<?php
$doc_name = "Dr. Suneedh Gupta";
$doc_title = "Best Oral & Maxillofacial Surgeon in Ambikapur | Dr. Suneedh Gupta";
$doc_desc = "Consult Dr. Suneedh Gupta, the best oral and maxillofacial surgeon in Ambikapur. Expert treatment for facial trauma, jaw surgery, and complex dental procedures.";
$doc_specialty = "Oral & Maxillofacial Surgery";
$doc_degree = "BDS, MDS (Oral & Maxillofacial Surgery)";
$doc_experience = "10+ Years";
$doc_designation = "Consultant Oral & Maxillofacial Surgeon";
$doc_image = "/assets/img/doctors/suneedh-gupta.jpg";
$doc_bio = "Dr. Suneedh Gupta is a highly skilled Oral & Maxillofacial Surgeon at Sankalp Hospital. He specializes in surgeries of the face, mouth, and jaws, including facial trauma management, oral pathology, and complex tooth extractions. He is dedicated to restoring facial function and aesthetics for his patients.";
$doc_keywords = ["Facial Trauma Surgery", "Jaw Realignment", "Oral Cancer Screening", "Complex Extractions", "Dental Implants"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row g-5">
      <div class="col-lg-7">
        <div class="doc-content">
          <h2>Oral & Maxillofacial Expertise</h2>
          <p>As the <strong>best oral surgeon in Ambikapur</strong>, Dr. Suneedh Gupta provides expert care for complex conditions of the mouth and face:</p>
          <div class="mb-4">
          ...
          <h2 class="mt-5">Specialized Surgical Care</h2>
          <p>Dr. Suneedh is known for his surgical precision in treating facial fractures and performing complex jaw surgeries. He works closely with other specialists at Sankalp Hospital to provide comprehensive care for trauma victims and patients with oral diseases.</p>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="sticky-top" style="top:100px">
          <div class="card border-0 shadow-lg rounded-4 p-4">
            ...
            <form accept-charset='UTF-8' action='https://app.formester.com/forms/UvGLKUCJe/submissions' method='POST'>
              ...
              <div class="mb-3">
                <label class="form-label small fw-bold">Dental/Oral Concern</label>
                <textarea name="message" class="form-control" rows="3">I need an oral surgery consultation.</textarea>
              </div>
